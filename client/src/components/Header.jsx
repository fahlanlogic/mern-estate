...
export default function Header() {
  ...
  return (
		<header>
			<nav className="w-full fixed bg-white shadow-md rounded-b-3xl z-50">
				<div className="flex justify-between mx-auto items-center px-3 py-4 md:max-w-2xl lg:max-w-4xl xl:max-w-6xl">
					<h1>
						<Link to="/">
							<div className="flex gap-1 items-center">
								<svg
									...
									strokeWidth={1.5}
									stroke="currentColor"
									className="w-7 h-7 text-pink-600 -rotate-90 xl:w-9 xl:h-9">
									<path
										strokeLinecap="round"
								...
								<span className="font-bold text-pink-600 xl:text-xl font-quikcsand">
									airbnb
								</span>
							</div>
						</Link>
					...
					<form
						...
						className="flex items-center p-0.5 xl:p-1.5 border rounded-full shadow-md">
						<input
							value={searchTerm}
							onChange={e =>
					...
					<ul className="flex sm:gap-5 items-center text-sm font-quikcsand font-semibold text-slate-700">
						<Link to="/create-listing">
							<li className="hover:bg-gray-100 px-3 py-2 rounded-full transition-all duration-300 hidden lg:block">
