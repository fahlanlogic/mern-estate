...
export default function CreateListing() {
  ...
  return (
		<main className="text-slate-700 md:max-w-2xl lg:max-w-4xl xl:max-w-6xl mx-auto font-quikcsand">
			<h1 className="text-3xl font-bold text-center pt-32 mb-14">
				Create a Listing
			</h1>
			<form
				onSubmit={handleSubmit}
				className="mx-5 flex flex-col gap-8 sm:flex-row">
					...
					<div className="flex gap-6 flex-wrap">
						<div className="flex items-center gap-2">
							<input
								...
								max="10"
								required
								className="border px-2 py-1 w-16 rounded-xl"
								onChange={handleChange}
						...
						<div className="flex items-center gap-2">
							<input
								...
								max="1000000"
								required
								className="border px-2 py-1 w-28 rounded-xl"
								onChange={handleChange}
				...
				<div className="flex flex-col flex-1 gap-4">
					...
					<div className="flex gap-3">
						...
						<button
							...
							className="border border-slate-700 px-3 rounded-xl hover:border-2 disabled:cursor-not-allowed disabled:opacity-80 uppercase font-semibold transition duration-300"
							...
							{imageUploading ? (
								...
								<svg
									...
									<path
										...
										fill="#334155"
										className="fill-334155"></path>
								</svg>
							)}
						</button>
					</div>
					<p className="text-red-500 text-sm">
						{imageErrorUpload && imageErrorUpload}
					</p>
					{formData.imageUrls.length > 0 &&
						formData.imageUrls.map((url, index) => (
							<div
								key={url}
								className="border rounded-xl items-center flex justify-between p-3">
								<img
									src={url}
									alt="listing-image"
					...
					<button
						...
						className="bg-gradient-to-b from-pink-500 to-pink-600 text-white px-3 py-2 rounded-full hover:opacity-90 disabled:opacity-80 font-semibold transition duration-300">
