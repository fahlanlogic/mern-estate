    ...
    <main className="text-slate-700 max-w-5xl mx-auto">
      ...
      <form className="mx-5 flex flex-col gap-8 sm:flex-row">
        ...
        <div className="flex flex-col flex-1 gap-4">
          ...
          <button type="button" className="bg-pink-500 text-white px-3 py-2 rounded-xl hover:bg-pink-700 disabled:opacity-80 font-semibold transition duration-300">Create Listing</button>
        </div>
      </form>
    </main>
  )
