...
export default function CreateListing() {
  ...
  return (
    <main>
      <div className="text-slate-700 px-4 mx-auto mt-20 md:w-5/6 md:mt-32 flex items-center">
        <div className="w-full">
          <h1 className="text-4xl font-bold text-center pb-16 lg:pb-24">
            Create a Listing
          </h1>
          <form
            ...
            <div className="flex flex-col flex-1 gap-4">
              ...
              <textarea
                ...
                className="border w-full px-3 py-2 rounded-xl h-40"
                onChange={handleChange}
            ...
            <div className="flex flex-col flex-1 gap-4">
              ...
              <button
                ...
                className="bg-gradient-to-b from-pink-500 to-pink-600 text-white px-3 py-2 rounded-full hover:opacity-80 disabled:opacity-70 font-semibold transition duration-300">
