...
export default function UpdateListing() {
  ...
  return (
    <main className="text-slate-700 max-w-5xl mx-auto">
      <h1 className="text-3xl font-bold text-center mt-16 mb-10">Update a Listing</h1>
      <form onSubmit={handleSubmit} className="mx-5 flex flex-col gap-8 sm:flex-row">
        ...
        <div className="flex flex-col flex-1 gap-4">
          ...
          <div className="flex gap-3">
            <input type="file" onChange={(e) => setFiles(e.target.files)} id="images" className="border p-2 w-full rounded-xl" accept="image/*" multiple/>
          ...
          <button disabled={loading || imageUploading} className="bg-pink-500 text-white px-3 py-2 rounded-xl hover:bg-pink-700 disabled:opacity-80 font-semibold transition duration-300">{ loading ? "Updating..." : "Update Listing"}</button>
